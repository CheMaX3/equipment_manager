...
insert into operational_area (full_name, short_name, conversational_name, section_id) values ("TestAreaFullName1","TestAreaShortName1","TestAreaConversationalName1","1"),
...
insert into equipment (machine_model, manufacturer_country , manufacturer, manufacturing_year, machine_number, details, type_id, area_id) values 
